...
while True:
    ...
    for x,y,w,h in faces:
        img = cv2.rectangle(img,(x,y),(x+w,y+h),(0,255,247),3)
        smiles = smileCascade.detectMultiScale(grayImg,1.8,15)
        for x,y,w,h in smiles:
            img = cv2.rectangle(img,(x,y),(x+w,y+h),(100,206,47),3)
            print("Image "+str(cnt)+"Saved")
            path=r'C:\\Users\\DELL\\Pictures\\project images\\img'+str(cnt)+'.jpg'
